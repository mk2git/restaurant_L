...
class ServeController extends Controller
{
    ...
    public function index()
    {
        ...
        $orders = Order::where('check_status', config('order.not yet'))->get();
        ...
        $confirm_table_orders = Order::where('check_status', config('order.not yet'))->get();
        $confirm_takeout_orders = Takeout_Order::where('check_status', 'not yet')->get();
