            ...
            <div class="modal-body">
                ...
                <form action="{{route('menu.update', $menu->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" id="name" value="{{$menu->name}}" class="form-control mb-4 mx-auto">
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="price" id="price" value="{{$menu->price}}" class="form-control mb-4 mx-auto" min="0">
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-8">
                            <textarea name="description" cols="20" rows="5" class="form-control">{{$menu->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input type="file" name="photo" id="photo" value="{{$menu->photo}}" class="form-control">
                        </div>
                    </div>
                    <hr>
