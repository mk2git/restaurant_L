...
<div class="modal fade" id="deleteMenuModal{{$menu->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteMenuModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('menu.destroy', $menu->id)}}" method="post">
                    ...
                    <p class="text-center">「 {{$menu->name}} 」を削除しますか？</p>
