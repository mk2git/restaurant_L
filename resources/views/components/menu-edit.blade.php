  ...
  <div class="row me-4">
      <div class="col-3">
          <button type="button" class="btn menu-img" data-bs-toggle="modal" data-bs-target="#menuModal{{$menuId}}" data-menu-id="{{ $menuId }}">
           ...
           <x-modal-select-menu-img :menu-id="$menuId" :menu-name="$menuName" :menu-img="asset('images/'. $menuPhoto)" />
      </div>
      <div class="col-2">・・・・・</div>
      <div class="col-3">
      ...
      <div class="col-2">
          <button type="button" class="edit-menu" data-toggle="modal" data-target="#editMenuModal{{$menuId}}" data-menu-id="{{ $menuId }}">
      ...
      <div class="col-2">
          <button type="button" data-toggle="modal" data-target="#deleteMenuModal{{$menuId}}" data-menu-id="{{ $menuId }}" class="delete-menu">
