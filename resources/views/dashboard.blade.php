<x-app-layout>
    ...
    <x-button-link :count-orders="$count_orders" :count-checkouts="$count_checkouts" :count-takeout-orders="$count_takeout_orders" :count-takeout-checkouts="$count_takeout_checkouts" />
